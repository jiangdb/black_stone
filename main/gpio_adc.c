...
void gpio_adc_init()
{
    ...
    gpio_config_t clk_conf={
        ...
        .pull_down_en=0,
        .pull_up_en=0,
        .pin_bit_mask=(1<<CH1_PIN_NUM_CLK)
    };
    gpio_config(&clk_conf);
    gpio_set_level(CH1_PIN_NUM_CLK, 0);
    ...
    gpio_config_t data_conf={
        ...
        .mode=GPIO_MODE_INPUT,
        .pull_up_en=1,
        .pin_bit_mask=(1<<CH1_PIN_NUM_DATA)
    };

    //Set up handshake line interrupt.
    gpio_config(&data_conf);
    // gpio_install_isr_service(0);
    gpio_isr_handler_add(CH1_PIN_NUM_DATA, data_isr_handler, NULL);
